...
export function getFrontendProgram(
  ...
  return new Program(
    {
      ...FrontendIDL,
      address: address ? address.toBase58() : FrontendIDL.address,
    } as Frontend,
    provider
  );
}
...
export function getFrontendProgramId(cluster: Cluster) {
  switch (cluster) {
    ...
    case "testnet":
      ...
      return new PublicKey("Fm78SojvrcVBss6Rhz4KUxRHsqEdPqBGzcax5noV5ksN");
    case "mainnet-beta":
    default:
